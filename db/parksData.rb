parks = [
    {
      ...
      },
      {
        ...
        "description": "Hawai‘i Volcanoes National Park protects some of the most unique geological, biological, and cultural landscapes in the world. Extending from sea level to the summit of Mauna Loa at 13,677 feet, the park encompasses the summits of two of the world's most active volcanoes - Kīlauea and Mauna Loa.",
        "images": [
          {
            "credit": "NPS / S. Geiger",
      ...
      },
      {
        ...
        "description": "With over 40% of the park water, Voyageurs is a maze of interconnected water highways. Plan ahead before coming to this water-based park by bringing your own watercraft, reserving a watercraft, or taking a park ranger boat tour.",
        "images": [
          {
            "credit": "NPS /Dimse",
      ...
      },
      {
        ...
        "description": "On March 1, 1872, Yellowstone became the first national park for all to enjoy the unique hydrothermal wonders. While snow and ice cover the landscape, life continues to thrive in the hot waters of the park and under the sheltering snow.",
        "images": [
          {
